...
df = pd.read_csv('prescaling_grid_search_parallel.csv')
params = pd.read_csv('all_combinations_prescaling.csv').reset_index().rename(columns={'index': 'param_id'})
...
df[['Q0', 'Q1', 'Q2', 'H0', 'H1', 'H2', 'stack_x0', 'stack_y0', 'stack_x1', 'stack_y1', 'stack_x2', 'stack_y2']].iloc[0].to_dict()
set_trace()
